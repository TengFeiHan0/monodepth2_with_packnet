...
class Trainer:
    def __init__(self, options):
        ...
        self.models["adaptive"]= robust_loss_pytorch.adaptive.AdaptiveImageLossFunction((640,192,3), float_dtype=np.float32, device='cuda:0')
        
        
        self.depth_parameters_to_train+= list(self.models["adaptive"].parameters())
    ...
    def compute_reprojection_loss(self, pred, target):
        ...
        l1_loss =torch.mean(self.models["adaptive"].lossfun(torch.abs(target - pred))[:, None])
        if self.opt.no_ssim:
